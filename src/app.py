...
activities = {
    ...
    "Soccer Club": {
        "description": "Play soccer and develop skills in an inclusive team environment",
    ...
    "Science Club": {
        "description": "Explore scientific experiments and concepts through hands-on learning",
